...
An important and valuable visualization task involves representing distributions. 
...
```{r production histo 2, echo = FALSE} 
...
A typical approach to representing these results is with a bar graph that includes standard error bars, like so:

```{r traditional bar chart, include = FALSE}

prop_gesture_type_axis %>%
...
waffle_1 <- waffle(c("vertical (above / below)" = 10, # "vertical (above / below)" = 5, 
            "horizontal (left-of / right-of)" = 10, # "horizontal (left-of / right-of)" = 5,
            "vertical (better / worse)" = 10,
            "horizontal (earlier / later)" = 10), rows = 4, 
